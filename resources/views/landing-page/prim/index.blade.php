...
<body>
    ...
    <!-- header area start  -->
    <header class="header-area header-bg-2 style-two img-fluid" id="home"
        style="margin-bottom: 10px; background: url('{{ asset('assets/landing-page/img/bg/header-bg-2.png') }}') no-repeat; padding-top: 150px; padding-bottom: 130px;">
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 justify-content-center">
                    ...
                    <div class="header-inner">
                        ...
                        <p class="white" style="font-size: 20px;">Sebuah sistem yang menyediakan perkhidmatan
                            pembayaran
                            dalam talian untuk pelbagai organisasi
                            berdaftar. Antara perkhidmatan yang telah kami sediakan ialah Derma, Yuran, Get&Go dan
                            sebagainya.</p>
            ...
            {{-- <div class="row justify-content-center" style="padding-top: 120px">
                <div class="col-lg-12 justify-content-center">
                    ...
                    <p class="white" style="font-size: 20px;">Parental Relationship Information Management (PRiM) adalah
                        sebuah sistem untuk menghubungkan
                        ...
                        <ul class="feature-list wow fadeInUp d-flex justify-content-center"
                            ...
                            <li class="single-feature-list col-md-9 col-lg-4">
                                ...
                                <div class="content">
                                    ...
                                    <p class="text-white">Memudahkan pembayaran dalam talian untuk transaksi atau
                                        pembayaran harian maupun bulanan.</p>
                                </div>
                            </li>
                            <li class="single-feature-list  col-md-9  col-lg-4">
                                <div class="icon icon-bg-2">
                                ...
                                <div class="content">
                                    ...
                                    <p class="text-white">Kebolehan untuk melakukan transaksi secara terus kepada
                                        penerima dengan pantas.</p>
                                </div>
                            </li>
                            <li class="single-feature-list col-md-9  col-lg-4">
                                <div class="icon icon-bg-2">
                                ...
                                <div class="content">
                                    ...
                                    <p class="text-white">Organisasi yang berdaftar adalah organisasi-organisasi yang
                                        diiktiraf oleh Bank Islam.</p>
                                </div>
                            </li>
                        </ul>
                    </div>
