...
<body>
    ...
    <main role="main">
        ...
        <section id="section-hero" aria-label="Hero Section">
            <div id="hero-wrapper">
                <img id="hero-deco" style="--transition-delay: 0.45s" class="slide-from-bottom-element" alt=""
                    src="{{ URL::asset('assets/landing-page/img/images/arrow_2.png') }}">
                <article id="hero-text">
                    <h1 class="mb-2 slide-from-bottom-element">Bayar Yuran Sekolah Dengan <span
                            class="color-primary">Mudah</span></h1>
                    <p class="mb-2 slide-from-bottom-element" style="--transition-delay: 0.15s">Urus pembayaran sekolah
                        anak anda dalam talian dengan
                        selamat dan cepat.</p>
                    <!-- From Uiverse.io by Creatlydev -->
                    <button id="btn-sign-up" class="btn btn-primary slide-from-bottom-element"
                        style="--transition-delay: 0.3s">
                        <span class="btn__icon-wrapper">
                            <svg viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="btn__icon-svg" width="10">
                                <path
                ...
                <img class="slide-from-bottom-element" style="--transition-delay: 0.45s" id="img-hero"
                    src="{{ URL::asset('assets/landing-page/img/images/hero_student.png') }}"
        ...
        <section id="section-feature" aria-label="Feature Section" class="container">
            <div id="feature-wrapper">
                <div class="mb-1-2 section-heading">
                    <img alt="" class="h2-deco-left"
                        src="{{ URL::asset('assets/landing-page/img/images/arrow_orange.png') }}">
                ...
                <div id="features">
                    <article class="feature-card slide-from-bottom-element">
                        <img class="img-fluid mb-1-2"
                            src="{{ URL::asset('assets/landing-page/img/images/icon_online_payment.png') }}"
                            alt="Icon for online payment">
                        <h3 class="mb-1">Ibu bapa perlu ke sekolah untuk bayar yuran</h3>
                        <p class="text-justify">Sistem ini membolehkan ibu bapa membuat pembayaran secara dalam talian
                            tanpa perlu hadir ke sekolah. Proses lebih mudah, cepat dan fleksibel mengikut
                            keselesaan ibu bapa.</p>
                    </article>

                    <article class="feature-card slide-from-bottom-element" style="--transition-delay: 0.15s">
                        <img class="img-fluid mb-1-2"
                            src="{{ URL::asset('assets/landing-page/img/images/icon_tracking.png') }}"
                            alt="Icon for easy tracking">
                        <h3 class="mb-1">Cikgu akan kumpul tunai yang banyak dan resit akan hilang</h3>
                        <p class="text-justify">Pembayaran tanpa tunai mengurangkan beban guru untuk mengurus wang
                            fizikal. Semua transaksi direkodkan secara automatik dan selamat dalam sistem. Dengan
                    ...
                    <article class="feature-card slide-from-bottom-element" style="--transition-delay: 0.3s">
                        <img class="img-fluid mb-1-2"
                            src="{{ URL::asset('assets/landing-page/img/images/icon_verification.png') }}"
                            alt="Icon for payments verification">
                        <h3 class="mb-1"> Cikgu perlu ambil masa untuk tulis resit secara manual</h3>
                        <p class="text-justify">Setiap transaksi akan disertakan dengan resit digital yang dijana secara
                            automatik. Guru tidak perlu lagi tulis resit secara manual dan menjadikan
        ...
        <section id="section-showcase" aria-label="Application Showcase Section" class="container">
            <div id="showcase-wrapper">
                <div class="mb-1-2 section-heading">
                    <img alt="" class="h2-deco-right"
                        src="{{ URL::asset('assets/landing-page/img/images/arrow_orange.png') }}">
                    <h2 class="h2 text-center">Paparan Sistem</h2>
                </div>
                <p class="text-center text-subtitle mb-4"> Setiap fungsi direka untuk memudahkan urusan pembayaran
                    yuran.</p>
                ...
                <div id="showcase-container">
                    ...
                    <div id="showcase-screenshots">
                        ...
                        <article class="showcase-screenshot slide-from-bottom-element">
                            <img src="{{ URL::asset('assets/landing-page/img/images/screenshot_mockup_1.svg') }}"
                                alt="Screenshot of receipt for paid school fee">
                        </article>

                        <article class="showcase-screenshot">
                            <img src="{{ URL::asset('assets/landing-page/img/images/screenshot_mockup_2.svg') }}"
                                alt="Screenshot of past receipts table">
                        </article>

                        <article class="showcase-screenshot">
                            <img src="{{ URL::asset('assets/landing-page/img/images/screenshot_mockup_3.svg') }}"
                                alt="Screenshot of generated fee payment report">
                        </article>
                    </div>
                </div>
        ...
        <section id="section-tutorial" aria-label="Tutorial on how to use the application section" class="container">
            <div id="tutorial-wrapper">
                ...
                <p class="text-center text-subtitle mb-4"> Video langkah demi langkah untuk membantu anda menggunakan
                    sistem tersebut.</p>
                <div id="video-container"
                    class="d-flex justify-content-center align-items-center slide-from-bottom-element">
                    <iframe id="iframe-tutorial" src="https://www.youtube.com/embed/m5GUnMwcG28?loop=1&controls=1"
                        allowfullscreen>
                    </iframe>
                </div>
            </div>
        ...
        <section id="section-member" aria-label="Member Section" class="container">
            <div id="member-wrapper">
                ...
                <p class="text-center text-subtitle mb-4">Terokai sekolah-sekolah di Malaysia yang telah berdaftar
                    dengan platform kami serta Bank Islam dan menikmati kemudahan pembayaran yuran yang
                ...
                <div class="text-bold text-center" id="member-count">{{ $organization2->count() }} <span
                        class="text-total">Sekolah (Jumlah):</span></div>

                <!--list of registered school members-->
                <div class="members">
                    @foreach ($organization2 as $key => $org)
                        <article class="member-card" data-state="{{ $org->state }}"
                            data-district="{{ $org->district }}">
                                ...
                                <div class="member-info-wrapper">
                                    ...
                                    <div class="member-info member-info-stats mb-1-2">
                                        ...
                                        <div>
                                            ...
                                            @if ($tcountLatest > 0)
                                                {{ $tcountLatest }} <span class="text-small"> transaksi pada
                                                    {{ $tcountYearLatest }}</span>
                                            @endif

                                        </div>
                                        <div>
                                            @if ($tcountPrevious > 0)
                                                {{ $tcountPrevious }} <span class="text-small"> transaksi pada
                                                    {{ $tcountYearPrev }}</span>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <div class="member-card-footer pt-3">
                                ...
                                @if ($organizationDonations->where('organization_id', $org->id)->first())
                                    <button class="btn-derma">
                                        <a
                                            href="/sumbangan/{{ $organizationDonations->where('organization_id', $org->id)->first()->url }}">Derma</a>
                                    </button>
                                @endif
                            </div>
                        </article>
        ...
        <section aria-label="Platform's Recognition" id="section-recognized-by">
            <div id="recognition-wrapper" class="container">
                ...
                <div id="recognized-by">
                    <img class="slide-from-bottom-element"
                        src="{{ URL::asset('assets/landing-page/img/MySTI-Color-Logo.png') }}" alt="Logo of MySTI"
        ...
        <section aria-label="Platform's Collaborators Section" id="section-collab">
            <div id="collab-wrapper" class="container">
                ...
                <p class="text-center text-subtitle mb-4">Laman web ini telah diakui dan disahkan selamat untuk
                    digunakan.
                </p>

                <div id="collaborators">
                    <img class="slide-from-bottom-element"
                        src="{{ URL::asset('assets/landing-page/img/images/paynet_logo.png') }}"
                        alt="Logo of Paynet Malaysia">
                    <img style="--transition-delay: 0.15s" class="slide-from-bottom-element"
                        src="{{ URL::asset('assets/landing-page/img/images/bank_islam_logo.png') }}"
                        alt="Logo of Bank Islam">
                ...
                <div id="accordion">
                    <div class="card slide-from-bottom-element">
                        <div class="card-header collapsed" id="headingOne" data-toggle="collapse"
                            ...
                            <img class="faq-arrow"
                                src="{{ URL::asset('assets/landing-page/img/images/chevron_down.png') }}"
                                alt="Click to show the answer for this question">
                        </div>

                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                            data-parent="#accordion">
                            <div class="card-body">
                                Kami tidak mengenakan sebarang bayaran kepada pihak PIBG sekolah. Walaubagaimanapun,
                                setiap kali pembayaran dibuat oleh ibu bapa atau penjaga, sistem akan mengenakan
                                caj sebanyak 50 sen.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card slide-from-bottom-element" style="--transition-delay: 0.15s">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                            data-parent="#accordion">
                            <div class="card-body">
                                Ibu bapa perlu login ke dalam laman web dengan menggunakan nombor kad pengenalan. Pihak
                                sekolah akan daftarkan setiap ibu bapa sebelum ibu bapa dibenarkan untuk log
                                masuk.
                            </div>
                        </div>
                    </div>
        ...
        <!--                            <textarea id="message" placeholder="Sebarang pertanyaan atau maklum balas untuk kami..." name="message"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const heroSlideFromBottomElements = document.querySelectorAll(
                '#section-hero .slide-from-bottom-element');
            const featureSlideFromBottomElements = document.querySelectorAll(
                '#section-feature .slide-from-bottom-element');
            const showcaseSlideFromBottomElements = document.querySelectorAll(
                '#section-showcase .slide-from-bottom-element');
            const tutorialSlideFromBottomElements = document.querySelectorAll(
                '#section-tutorial .slide-from-bottom-element');
            const statSlideFromBottomElements = document.querySelectorAll(
                '#section-stat .slide-from-bottom-element');
            let memberSlideFromBottomElements = document.querySelectorAll(
                '#section-member .slide-from-bottom-element');
            const organizationSlideFromBottomElements = document.querySelectorAll(
                '#section-organization   .slide-from-bottom-element');
            const collabSlideFromBottomElements = document.querySelectorAll(
                '#section-collab .slide-from-bottom-element');
            const faqSlideFromBottomElements = document.querySelectorAll('#section-faq .slide-from-bottom-element');
            const contactSlideFromBottomElements = document.querySelectorAll(
                '#section-contact .slide-from-bottom-element');
            const recognitionSlideFromBottomElements = document.querySelectorAll(
                '#section-recognized-by .slide-from-bottom-element');
            ...
            statesSelect.addEventListener('change', function() {
                ...
                if (selectedState !== 'all' && districtsByState[selectedState]) {
                    Object.keys(districtsByState[selectedState]).sort().forEach(district => {
                        ...
                        option.textContent =
                            `${district} (${districtsByState[selectedState][district]})`;
            ...
            function displayCurrentPageCards() {
                ...
                memberSlideFromBottomElements = document.querySelectorAll(
                    '#section-member .slide-from-bottom-element');
                for (let el of memberSlideFromBottomElements) {
                    observerSlideBottomElement.observe(el);
                }
            ...
            function getLocationDetails(lat, lon) {
                ...
                fetch(
                        `https://nominatim.openstreetmap.org/reverse?lat=${lat}&lon=${lon}&format=json&zoom=18&accept-language=ms`)
