            ...
            <div class="responsive-mobile-menu">
                <div class="logo-wrapper">
                    <a href="index.html" class="logo">
                        <img src="{{ URL::asset('assets/landing-page/img/logo-white.png') }}" alt="logo">
                    </a>
                </div>
            ...
            <div class="nav-right-content">
                <ul>
                    <li class="button-wrapper">
                        <a href="/login" class="boxed-btn btn-rounded">Login</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="img-with-video">
                        <div class="img-wrap">
                            <img src="{{ URL::asset('assets/landing-page/img/video-image.jpg') }} " alt="">
                            <div class="hover">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="center-image">
                        <img src="{{ URL::asset('assets/landing-page/img/mobile-img-2.png') }} " alt="mobile image two">
                    </div>
                </div>
                <div class="col-lg-4 col-md-12">
                    <div class="single-why-us-item margin-top-60 wow zoomIn"><!-- single why us item -->
                                        ...
                                        <div class="col-lg-6">
                                            <div class="right-content-area">
                                                <div class="img-wrapper">
                                                    <img src="{{ URL::asset('assets/landing-page/img/how-it-works-image.png') }}" alt="how it works image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-12">
                    <div class="team-carousel"><!-- team carousel -->
                        <div class="single-team-member"><!-- single team member -->
                            <div class="thumb">
                                <img src="{{ URL::asset('assets/landing-page/img/team-member/01.jpg') }}" alt="team member image">
                                <div class="hover">
                        ...
                        <div class="single-team-member"><!-- single team member -->
                            <div class="thumb">
                                <img src="{{ URL::asset('assets/landing-page/img/team-member/02.jpg') }}" alt="team member image">
                                <div class="hover">
                                    <ul class="social-icon">
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                        ...
                        <div class="single-team-member"><!-- single team member -->
                            <div class="thumb">
                                <img src="{{ URL::asset('assets/landing-page/img/team-member/03.jpg') }}" alt="team member image">
                                <div class="hover">
                                    <ul class="social-icon">
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                        ...
                        <div class="single-team-member"><!-- single team member -->
                            <div class="thumb">
                                <img src="{{ URL::asset('assets/landing-page/img/team-member/04.jpg') }}" alt="team member image">
                                <div class="hover">
                                    <ul class="social-icon">
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                        ...
                        <div class="single-team-member"><!-- single team member -->
                            <div class="thumb">
                                <img src="{{ URL::asset('assets/landing-page/img/team-member/05.jpg') }}" alt="team member image">
                                <div class="hover">
                                    <ul class="social-icon">
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
