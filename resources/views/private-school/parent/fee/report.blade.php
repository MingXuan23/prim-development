...
@section('content')
                ...
                <div class="card-body">
                    <div class="mb-4">
                        <div class="float-left mini-stat-img mr-4">
                            <img src="{{ URL::asset('assets/images/services-icon/donation.png') }}" alt="">
                        </div>
                        <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Kategori A</h5>
                        <h4 class="font-weight-medium font-size-24" id="total_donor">RM 0.00</h4>
        ...
        <div class="col-xl-6 col-md-9">
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        <div class="float-left mini-stat-img mr-4">
                            <img src=" {{ URL::asset('assets/images/services-icon/donate.png') }}" style="max-width: 40px" alt="">
                        </div>
                        <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Kategori B</h5>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Carta Transaksi Yuran</h4>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Transaksi terkini</h4>
