...
<div class="row">
    <div class="card col-md-12">
        ...
        @endif
        <form method="post" action="{{ route('private-school.teacher.store') }}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="icno" name="icno" class="form-control" placeholder="No IC" max="13"> --}}
                </div>
