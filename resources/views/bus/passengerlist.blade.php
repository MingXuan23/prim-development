...
<div class="row align-items-center">
    <div class="col-sm-6">
        <div class="page-title-box">
            <h4 class="font-size-18">Pilih Bas untuk Semak Senarai Penumpang</h4>
        </div>
    </div>
</div>
<div class="row">
            ...
            <div class="flash-message"></div>
                ...
                <table id="managecar" class="table table-bordered table-striped dt-responsive wrap"
                        ...
                        <tr>
                            ...
                            <th>List Passenger</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach ($data as $item)
                        <tr>                
                        <form action="/passengerlist-bus/{{ $item->id }}" method="POST">
                            @csrf
                            <td>{{ $item->id }}</td>
                            ...
                            <td> <button type="submit" class="btn btn-primary">Show List Passenger</button></td>
                        </form>
                        </tr>
                        @endforeach
                        </tbody>
