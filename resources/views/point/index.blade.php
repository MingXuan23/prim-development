                    ...
                    <div id="progressBars">
                        <label class="col-form-label">
                            @if($streakData['streak_today'])
                                <div>
                                    <i class="fas fa-check-circle text-success"></i> PRiM Medal @if (isset($streakData['streak_startdate'])) Mulai {{$streakData['streak_startdate']}} @endif:
                                    {{ $streakData['current_streak'] }}/40 Hari
                                </div>
                            @else
                                <div class="text-danger">
                                    <i class="fas fa-exclamation-circle text-danger"></i> PRiM Medal @if (isset($streakData['streak_startdate'])) Mulai {{$streakData['streak_startdate']}} @endif:
                                    {{ $streakData['current_streak'] }}/40 Hari
                                </div>
                            @endif
                        </label>
                        ...
                        <div class="progress mb-3" style="height: calc(1.5em + 0.75rem + 2px);">
                            <div class="progress-bar {{ $streakData['streak_today'] ? 'bg-warning' : 'bg-danger' }}" style="width: {{ $streakData['current_streak'] * 2.5 }}%;" role="progressbar"
                                aria-valuenow="{{ $streakData['current_streak'] }}" aria-valuemin="0" aria-valuemax="40">
                    ...
                    <div id="progressBars">
                        <label class="col-form-label">
                            @if($sedekah_subuh['streak_today'])
                                <div>
                                    <i class="fas fa-check-circle text-success"></i> Sedekah Subuh @if (isset($sedekah_subuh['streak_startdate'])) Mulai {{$sedekah_subuh['streak_startdate']}} @endif:
                                    {{ $sedekah_subuh['current_streak'] }}/40 Hari
                                </div>
                            @else
                                <div class="text-danger">
                                    <i class="fas fa-exclamation-circle text-danger"></i> Sedekah Subuh @if (isset($sedekah_subuh['streak_startdate'])) Mulai {{$sedekah_subuh['streak_startdate']}} @endif:
                                    {{ $sedekah_subuh['current_streak'] }}/40 Hari
                                </div>
                            @endif
                        </label>
                        ...
                        <div class="progress mb-3" style="height: calc(1.5em + 0.75rem + 2px);">
                            <div class="progress-bar {{ $sedekah_subuh['streak_today'] ? 'bg-warning' : 'bg-danger' }}" style="width: {{ $sedekah_subuh['current_streak'] * 2.5 }}%;" role="progressbar"
                                aria-valuenow="{{ $sedekah_subuh['current_streak'] }}" aria-valuemin="0" aria-valuemax="40">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab1" role="tabpanel">
                        <div class="table-responsive">
                            <table id="pointHistoryTable" class="table table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                    ...
                    <div class="tab-pane" id="tab2" role="tabpanel">
                        <div class="table-responsive">
                            <table id="memberTable" class="table table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <div class="tab-pane" id="tab3" role="tabpanel">
                        <div class="table-responsive">
                            <table id="streakTable" class="table table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <div class="tab-pane" id="tab4" role="tabpanel">
                        <div class="table-responsive">
                            <table id="sedekahTable" class="table table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
