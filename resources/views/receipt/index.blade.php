                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="content-block">
                                                        @if (isset($organization->organization_picture))
                                                            <img src="{{ URL::asset('/organization-picture/' . $organization->organization_picture) }}" height="100" class="mb-3 d-block mx-auto">
                                                        @endif
