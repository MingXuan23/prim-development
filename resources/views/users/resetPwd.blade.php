...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="profile_reset_password" class="form-horizontal mt-4" method="post" >
                @csrf
                <!-- old password -->
                ...
                <div class="form-group row  mb-0">
                    <div class="col-12 text-right">
                        <button type="button" class="btn btn-light w-md waves-effect waves-light" onclick="window.location='{{ url("/profile_user") }}'">Kembali</button>
