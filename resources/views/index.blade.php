                    ...
                    <div class="card-body">
                        ...
                        <div class="pt-2 float-right">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <button id="btn_donor_day" onclick="getTotalDonor(this.id)"  class="btn btn-secondary">Hari ini</button>
                                <button id="btn_donor_week" onclick="getTotalDonor(this.id)"  class="btn btn-secondary">Minggu ini</button>
                                <button id="btn_donor_month" onclick="getTotalDonor(this.id)"  class="btn btn-secondary">Bulan ini</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6 col-md-9">
                <div class="card mini-stat bg-primary text-white">
                    <div class="card-body">
                        ...
                        <div class="pt-2 float-right">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <button id="btn_day" class="btn btn-secondary" onclick="getTotalDonation(this.id)" >Hari ini</button>
                                <button id="btn_week" class="btn btn-secondary" onclick="getTotalDonation(this.id)" >Minggu ini</button>
                                <button id="btn_month" class="btn btn-secondary" onclick="getTotalDonation(this.id)" >Bulan ini</button>
                        </div>
                        </div>
                    </div>
                </div>
