    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Tutup Derma</h4>
        </div>
        <div class="modal-body">
          Adakah anda pasti?
        </div>
        <div class="modal-footer">
          <button type="button" data-dismiss="modal" class="btn btn-primary" id="delete" name="delete">Teruskan</button>
      ...
      $('#delete').click(function () {
        $.ajax({
          ...
          success: function (data) {
            ...
            // get the message from the data (html code)
            var message = $('<div>')
              .html(data)
              .find('.alert')
              .find('button')
