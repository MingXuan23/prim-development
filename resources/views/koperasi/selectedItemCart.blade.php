  ...
  <div class="row d-flex justify-content-center align-items-center">
    <div class="col">
      ...
      <div class="card">
        ...
        @php
            $out_of_stock = $cart_item->contains(function ($item) {
            ...
            <table class="table table-borderless" width="100%" cellspacing="0">
                <thead>
                    <tr class="text-center">
                      ...
                      <th style="width: 10%" class ="d-none d-md-table-cell ">Harga Per Units(RM)</th>
                      ...
                      <tr class="text-center" >
                        ...
                        <td class="align-middle">{{ $row->name }} 
                          <span class="d-md-none">
                            <br>RM {{ number_format($row->price, 2, '.', '') }}
                        </span>
                        </td>
                        <td class="align-middle d-none d-md-table-cell"> {{ number_format($row->price, 2, '.', '')}}</td>
                        ...
                        <td class="align-middle">
                          ...
                          <div class = "quantity-container " >
                                      <div class="quantity-input-container "style="width: 100%" data-product-order-id="{{$row->productOrderId}}"  data-pgng-order-id="{{$row->pgngId}}" >
                                          ...
                                          @else
                                          <h6 data-qty-available="{{$row->quantity_available}}" id="quantity-available" class="text-danger">0 barang dalam stock</h6>
                                          @endif
      ...
      @endif
              ...
              <div class="col">
                <div class="form-group required">
                  ...
                  <div class="col note-div">
                    <input type="text" name="note" class="form-control noteTxt"  placeholder="Optional" data-parsley-required-message="Sila isi nota">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row mb-2">
          <div class="col d-flex justify-content-end">
            ...
            @if($cart)
              <button type="submit" class="btn btn-primary" @if($out_of_stock) disabled @endif >Bayar</button>
            @endif
          </div>
        </div>
...
<script>
        ...
        minusButton.addEventListener("click",function(){
            ...
            if(inputQuantity >= 1){
               if(inputQuantity==1){
                ...
                window.alert('Quantiti Barang mesti melebihi 1')
               }
               else{
                inputQuantity--;
    ...
    var noteInputs = $('.noteTxt');

    var joinedValue = noteInputs.map(function() {
        return $(this).val();
    }).get().join('|');

    // Update the value of each input element with the joined value
    $('.noteTxt').val(joinedValue);
