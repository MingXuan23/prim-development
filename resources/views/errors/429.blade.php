                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-4 ms-auto">
                                        <div class="ex-page-content">
                                            ...
                                            <h4 class="mb-4">Terlalu banyak permohonan</h4>
                                            {{-- <p class="mb-5">Kepada penderma yang menggunakan IPHONE atau IOS
                                                operating system. Kami mohon maaf kerana ada kalanya framework yang kami
                                                guna akan ada ralat. Transaksi derma tuan/puan TELAH BERJAYA. Kami
                                                sedang usaha untuk buat mobile apps untuk penderma IOS. Terima kasih</p>
                                            --}}
                                            <a class="btn btn-primary mb-5 waves-effect waves-light"
                                                href="{{ route('student.parentRegisterStudents.create') }}"><i
