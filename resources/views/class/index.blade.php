    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                {{-- <div class="">
                    <button onclick="filter()" style="float: right" type="submit" class="btn btn-primary"><i class="fa fa-search"></i>
                        Tapis</button>
                </div> --}}
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div>
                    ...
                    <a style="margin-top:19px;float: right;" href="#" class="btn btn-warning" id="dummyBtn"> <i class="fas fa-plus"></i> Tambah Dummy Kelas</a>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="classesTable" class="table table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
