...
<div class="row">
    <div class="card col-md-12">
        ...
        @endif
        <form class="form-validation" method="post" action="" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="card-body">
                ...
                <div class="yearhide form-group">
                    <label>Tahap</label>
                    <select name="year" id="year" class="form-control" data-parsley-required-message="Sila pilih tahap" required>
