                    ...
                    <div class="card-body py-4">
                        ...
                        <div class="row">
                            <div class="col-12 text-center mb-3">
                                <img src="{{ URL::asset('/organization-picture/'.$get_organization->organization_picture) }}" height="60" alt="" />
                            </div>
                            <div class="col-12 text-center mb-3">
                            ...
                            <div class="col-12 pt-3">
                                ...
                                <div class="row g-0">
                                    <div class="col-12 col-md-6">
                                        <table class="table table-borderless infotbl mb-0">
                                            <tr>
                                                <td class="col-5"><strong>Nama</strong></td>
                                                <td class="col-1">:</td>
                                                <td class="col-6">{{ $getparent->name }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <table class="table table-borderless infotbl mb-0">
                                            <tr>
                                                <td class="col-5"><strong>No. Kad Pengenalan</strong></td>
                                                <td class="col-1">:</td>
                                                <td class="col-6">
                                                    @if($getparent->icno)
                                                    {{ $getparent->icno }}
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            {{ number_format((float)$item->fr_finalamount, 2, '.', '')  }}
                                        </td>
                                    </tr>
                                    @endforeach
