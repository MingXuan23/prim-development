...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Tambah Butiran Kategori Yuran Berulang</h4>
    ...
    <div class="row">
        <div class="card col-md-12">
            ...
            @endif
            <form class="form-validation" method="POST" action="{{ route('fees.storeRecurring') }}"
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (year == "All_Year") {
                                ...
                                $(".cbhide div").remove();
                                $(".cbhide").append(
                                    "<div class='col-md-2 col-sm-4 mb-2'><label for='checkAll' style='margin-right: 22px;' class='form-check-label'> <input class='form-check-input' type='checkbox' id='checkedAll' name='all_classes' value=''/> Semua Kelas </label></div>"
                                );

                                jQuery.each(result.success, function (key, value) {
                                    $(".cbhide").append(
                                        "<div class='col-md-2 col-sm-4 mb-2'><label for='cb_class' style='margin-right: 22px;' class='form-check-label'> <input class='checkSingle form-check-input' data-parsley-required-message='Sila pilih kelas' data-parsley-errors-container='.errorMessageCB' type='checkbox' id='cb_class' name='cb_class[]' value='" +
