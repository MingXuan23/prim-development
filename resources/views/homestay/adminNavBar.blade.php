<div class="page-title-box d-flex justify-content-center align-items-center flex-wrap">
    <div class="admin-nav-links d-flex justify-content-center align-items-center flex-wrap">
        ...
        <a href="{{route('homestay.promotionPage')}}" id="manage-promotion" class="btn-dark-purple m-2"><i class="fas fa-percentage"></i> Urus Promosi</a>
        <a href="{{route('homestay.urustempahan')}}" id="manage-booking" class="btn-dark-purple m-2"><i class="fas fa-concierge-bell"></i> Urus Tempahan Pelanggan</a>
