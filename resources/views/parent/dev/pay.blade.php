        ...
        <div class="card rounded-xl mt-4">
            ...
            <div class="card-text p-4">
                        ...
                        <div class="row">
                            ...
                            @foreach ($getdetails->where('feeid', $row->feeid) as $row3)
                                ...
                                <div class="col-6">
                                    ...
                                    @endphp
                                    <h4 class="float-right">RM {{ number_format($row3->quantity * $row3->price, 2) }}
                                    </h4>
                                </div>
                ...
                <div class="form-group">
                    ...
                    <form method="POST" action="{{ route('receiptdev') }}" enctype="multipart/form-data">
                ...
                {{ csrf_field() }}
                <input type="hidden" name="amount" id="amount" value={{ $i }}>
                <input type="hidden" name="o_id" id="o_id" value="{{ 1 }}">
                <input type="hidden" name="feesid" id="feesid" value="{{ $allfeesid }}">
