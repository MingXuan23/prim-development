                                ...
                                <div class="card mb-1">
                                    <div class="card-body py-5">
                                        <div class="row">
                                            <div class="col-2 p-0">
                                                <center>
                                                    <img src="{{ URL::asset('assets/images/logo/prim-logo.svg') }}"
                                                        height="80" alt="" />
                                                </center>
                                            </div>
                                            <div class="col-6 p-0">
                                            ...
                                            <div class="col-4">
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        <td>Tarikh</td>
                                                        <td style="width: 50px">:</td>
                                                        <td>{{ $get_transaction->datetime_created->format('j M Y H:i:s A')}}
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="col-12 pt-3">
                                                ...
                                                <div class="pt-2"
                                                    style="border-bottom:2px solid #e0e0e0;font-size: 18px">
                                                    {{ $student->studentnama }}
                                                </div>
                                                <center class="my-2">
                                                ...
                                                <table class="table table-bordered table-striped" style="">
                                                    ...
                                                    @foreach ($getdetail->where('studentid',
                                                    $student->studentid)->where('catid',
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            {{  number_format((float)$item->detailsprice, 2, '.', '') }}
                                                        </td>
                                                        <td style="text-align: center">
                                                ...
                                                <div class="col-12 pt-5 text-center">
                                                    ...
                                                    <a href="/home">
                                                        <button class="btn btn-danger p-2 w-10 mx-2"
