...
Route::group(['middleware' => ['auth'], 'prefix' => 'donate'], function () {
    ...
    Route::get('donor/codedonor/list/datatable', 'DonationController@getDonorCodeDatatable')->name('donate.donor_code_datatable');
    Route::get('donor/code/list/datatable', 'DonationController@getCodeDatatable')->name('donate.code_datatable');
...
Route::group(['prefix' => 'sedekah-subuh', 'middleware' => 'auth'], function () {
    // page routes
...
Route::post('directpayIndex', 'DirectPayController@newDirectpayIndex')->name('directpayIndex');
...
//mobile orders
Route::get('/cart/mobilepayment', 'OrderSController@mobilepayment')->name('orders.mobilepayment');
Route::get('/cart/receipt/{transaction_id}', 'OrderSController@cartreceipt')->name('orders.cartreceipt');
