    ...
    public function directpayIndex(Request $request)
    {
        ...
        try {
            ...
            if ($transaction->save()) {
                ...
                $trimmedSellerExOrderNo = str_replace("PRIM_", "", $fpx_sellerExOrderNo);

                if (substr($trimmedSellerExOrderNo, 0, 1) == 'S') {
                ...
                } else if (substr($trimmedSellerExOrderNo, 0, 1) == 'F') {
                    $result = DB::table('orders')
                        ->where('id', $request->order_id)
                        ->update([
                            'transaction_id' => $transaction->id
                        ]);
                } else if (substr($trimmedSellerExOrderNo, 0, 1) == 'M') {
                ...
                } else if (substr($trimmedSellerExOrderNo, 0, 1) == 'K') {
                ...
                } else if (substr($trimmedSellerExOrderNo, 0, 1) == 'H') {
                ...
                } else if (substr($trimmedSellerExOrderNo, 0, 1) == 'O') {
                    if ($request->mobile != 'true') {
                        $result = DB::table('orders')
                            ->where('id', $orderId)
                            ->update([
                ...
                } else if (substr($trimmedSellerExOrderNo, 0, 1) == 'G') {
                    $result = DB::table('grab_bookings')
                        ->where('id', $bookingId)
                        ->update([
                            'transactionid' => $transaction->id
                        ]);
                } else if (substr($trimmedSellerExOrderNo, 0, 1) == 'B') {
                    $result = DB::table('bus_bookings')
                        ->where('id', $bookingId)
                        ->update([
                            'transactionid' => $transaction->id
                        ]);
                } else if (substr($trimmedSellerExOrderNo, 0, 1) == 'R') {
