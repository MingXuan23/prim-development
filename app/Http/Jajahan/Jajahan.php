...
class Jajahan
{
    ...
    public static function daerah($state_id)
    {
        $items = [
            /*
        ...
        for ($i=0; $i < count($items) ; $i++) {
            if ($state_id == $items[$i]['state_id']) {
                array_push($districts, $items[$i]['name']);
            }
        }
