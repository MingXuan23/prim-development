...
class ExportClassTransaction implements FromCollection, ShouldAutoSize, WithHeadings
{
    ...
    */
    public function collection()
    {
        ...
        foreach ($datas as $key => $data) {
            ...
            $temp = new stdClass();
            $temp->organization_name = $this->org->nama;
            $temp->nama =  $data->nama;
            $temp->nama_kelas = $data->nama_kelas;

            $temp->date = $transaction_date==''? $transaction_date:'`'. $transaction_date;
